...
for y = 1:2
    ...
    if y == 1
        cog_assess.rewp.data = grand_summary;
    elseif y == 2
        cog_assess.p300.data = grand_summary;
    end
    ...
    if y == 1
        cog_assess.rewp.std = grand_summary;
    elseif y == 2
        cog_assess.p300.std = grand_summary;
    end
    ...
    if y == 1
        cog_assess.rewp.anova = grand_summary;
    elseif y == 2
        cog_assess.p300.anova = grand_summary;
    end
