...
%  09-19-16 duplicated from runica from eeglab under GPL and rand state initialization commented out.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [weights,sphere,meanvar,bias,signs,lrates,data,y] = el_runica(data,varargin) % NB: Now optionally returns activations as variable 'data' -sm 7/05
