...
# Load Data
{
  stimulusFzData = loadData(
    "../../Data/MedEd/R/FFT Data/stimulusFz.csv",
    "../../Data/MedEd/R/FFT Data/frequency.csv"
  )
  stimulusPzData = loadData(
    "../../Data/MedEd/R/FFT Data/stimulusPz.csv",
    "../../Data/MedEd/R/FFT Data/frequency.csv"
  )
  responseFzData = loadData(
    "../../Data/MedEd/R/FFT Data/responseFz.csv",
    "../../Data/MedEd/R/FFT Data/frequency.csv"
  )
  responsePzData = loadData(
    "../../Data/MedEd/R/FFT Data/responsePz.csv",
    "../../Data/MedEd/R/FFT Data/frequency.csv"
  )
}
...
{
  ggsave(
    filename = "../../Data/MedEd/Plots/plotFFT.jpeg",
    plot = summaryPlot,
    width = 13.08,
    height = 8.72,
    dpi = 600
