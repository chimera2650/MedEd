...
for z = 1:2
    ...
    summary.(analysis) = [];
    summary.(analysis).ttest = [];
    summary.(analysis).ttest = string(summary.(analysis).ttest);
    summary.(analysis).ttest(2,1) = '0-1';
    summary.(analysis).ttest(3,1) = '0-2';
    summary.(analysis).ttest(4,1) = '1-2';
    summary.(analysis).ttest(1,2) = 'accuracy';
    summary.(analysis).ttest(1,3) = 'reactiontime';
    summary.(analysis).ttest(1,4) = 'confidence';
    ...
    summary.(analysis).correlation = string(summary.(analysis).correlation);
    summary.(analysis).correlation(1,1) = 'winloss';
    summary.(analysis).correlation(2,1) = round(corr(subject_data.cfscore,subject_data.winloss),3);
    summary.(analysis).correlation(1,2) = 'RT';
    summary.(analysis).correlation(2,2) = round(corr(subject_data.cfscore,subject_data.RT),3);
    summary.(analysis).correlation(1,3) = 'confidence';
    summary.(analysis).correlation(2,3) = round(corr(subject_data.cfscore,subject_data.confidence),3);
    ...
    summary.(analysis).ttest(2,2) = ttest(accuracy.significance.c0,accuracy.significance.c1);
    summary.(analysis).ttest(3,2) = ttest(accuracy.significance.c0,accuracy.significance.c2);
    summary.(analysis).ttest(4,2) = ttest(accuracy.significance.c1,accuracy.significance.c2);
    ...
    for i = 1:file_num
        file_name = [raw_dir prefix sub_num{i} '.mat'];
        load(file_name);
    ...
    summary.(analysis).accuracy = accuracy;
    summary.(analysis).reactiontime = reactiontime;
    summary.(analysis).confidence = confidence;
    summary.(analysis).variables = variables;
end
