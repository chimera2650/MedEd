...
if strcmp(comp,'JORDAN-SURFACE') == 1
    ...
    save_dir = 'C:\Users\chime\Documents\MATLAB\Data\MedEd\med_ed_nperm.mat';
elseif strcmp(comp,'OLAV-PATTY') == 1
    master_dir = 'C:\Users\Jordan\Documents\MATLAB\Data\MedEd';
    save_dir = 'C:\Users\Jordan\Documents\MATLAB\Data\MedEd\med_ed_nperm.mat';
end
...
for a = 1:2
    ...
    for b = [28,53]
        ...
        WAV_data = squeeze(summary.(analysis).data(b,1:29,:,:,:));
        ...
        dispstat('','init');
        dispstat(sprintf(['Permuting ' chanlocs(b).labels ' wavelets for '...
    ...
    disp('Saving data');
    perm.(analysis).data = data;
    perm.(analysis).cluster = cluster;
    perm.(analysis).maximum = maximum;
    perm.(analysis).freq = freq_point;
    perm.(analysis).time = time_point;
